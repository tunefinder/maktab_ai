...
console.log('🤖 Novda AI SaaS Telegram Bot ishga tushmoqda...');
...
async function sendInvoice(chatId, itemKey) {
  let title = "Ustoz PRO";
...
2. Kalitni joylashtirib, <b>"Faollashtirish"</b> tugmasini bosing! 🚀
    ...
    console.error("Error creating trial key in bot:", err);
    await sendMessage(chatId, "❌ Kalit yaratishda xatolik yuz berdi.");
  }
}

async function approvePayment(adminChatId, messageId, customerChatId, itemKey) {
  try {
...
async function startPolling() {
  console.log('✅ Novda AI SaaS Telegram to\'lov boti muvaffaqiyatli ishga tushdi va xabarlarni tinglamoqda!');
